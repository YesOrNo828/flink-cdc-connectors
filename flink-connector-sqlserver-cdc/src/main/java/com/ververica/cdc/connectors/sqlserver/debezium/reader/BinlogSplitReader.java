...
// */
//
//package com.ververica.cdc.connectors.sqlserver.debezium.reader;
//
//import com.ververica.cdc.connectors.sqlserver.debezium.task.SqlServerBinlogSplitReadTask;
...
// */
//public class BinlogSplitReader implements DebeziumReader<SourceRecord, SqlServerSplit> {
//
...
//	private SqlServerSplit currentBinlogSplit;
...
//	}
//
//	public void submitSplit(SqlServerSplit sqlServerSplit) {
//		this.currentBinlogSplit = sqlServerSplit;
//		configureFilter();
